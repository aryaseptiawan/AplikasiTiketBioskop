...
public class CRUD_User {
    ...
    private String id_staff, username, password, nama, nama_bioskop;
    public CRUD_User() {
    }

    public CRUD_User(String username, String password, String nama, String nama_bioskop) {
    ...
    //deklarasi connection dan preparedStatement
        ...
        String insertTableSQL = "INSERT INTO staff"
                + "(username, password, nama, nama_bioskop) VALUES"
                + "(?,?,?,?)";
        try {
    ...
    public boolean ubahData(String id_staff, String username_baru, String password_baru, String nama_baru, String nama_bioskop_baru)
            throws SQLException {
    //deklarasi connection dan preparedStatement
        Connection dbConnection = null;
        PreparedStatement ps = null;
