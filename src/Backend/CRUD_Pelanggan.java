...
public class CRUD_Pelanggan {
    ...
    private String id_pelanggan, nama, nama_bioskop, nomor_studio, judul, waktu_pemesanan, tanggal, waktu_mulai, waktu_selesai, baris, nomor_bangku, harga, pembayaran, kembalian;

    public CRUD_Pelanggan() {
    }

    public CRUD_Pelanggan(String nama, String nama_bioskop, String nomor_studio, String judul, String tanggal, String waktu_mulai, 
            String waktu_selesai, String baris, String nomor_bangku, String harga, String pembayaran, String kembalian) {
        this.nama = nama;
    ...
    public void lihatNData() throws SQLException {
        try {
            ...
            while (rs.next()) {
                ...
                System.out.println("pembayaran: " + rs.getString(13));
                System.out.println("kembalian: " + rs.getString(14));
                System.out.println("");
            }
    ...
    //deklarasi connection dan preparedStatement
        ...
        String insertTableSQL = "INSERT INTO pelanggan"
                + "(nama, nama_bioskop, nomor_studio, judul, tanggal, waktu_mulai, waktu_selesai, baris, nomor_bangku, harga, pembayaran, kembalian) VALUES"
                + "(?,?,?,?,?,?,?,?,?,?,?,?)";
        try {
    ...
    //Langkah ke 4 bagian 1
            ...
            ps.setString(10, this.pembayaran);
            ps.setString(10, this.kembalian);
    ...
    public boolean ubahData(String id_pelanggan, String nama_baru, String nama_bioskop_baru, String nomor_studio_baru, String judul_baru, String tanggal_baru, String waktu_mulai_baru, String waktu_selesai_baru, String baris_baru, String nomor_bangku_baru, String harga_baru, String pembayaran_baru, String kembalian_baru)
            throws SQLException {
    //deklarasi connection dan preparedStatement
        Connection dbConnection = null;
        PreparedStatement ps = null;
        ...
        String updateTableSQL = "UPDATE pelanggan SET nama = ?, nama_bioskop = ?, nomor_studio = ?,"
                ...
                + " baris = ?, nomor_bangku = ?, harga = ?, pembayaran = ?, kembalian = ?, WHERE id = ?";
        try {
    //buka koneksi saat objek dari desa ninja dibentuk
            kdb.bukaKoneksi();
    //inisialisasi dbConnection dari objek Connection
    ...
    //Langkah ke 4 bagian 1
            ...
            ps.setString(11, pembayaran_baru);
            ps.setString(12, kembalian_baru);
    //langkah 4: eksekusi query
            rowAffect = ps.executeUpdate();
        } catch (Exception e) {
            System.out.println(e.getMessage());
