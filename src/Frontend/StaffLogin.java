...
public class StaffLogin extends javax.swing.JFrame {
    ...
    private void koneksi(){
        try{
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost/sistem tiket bioskop","root","");
            ...
            if(username.length()>50){
                ...
                try{
                    ...
                    if (res.next()){
                        ...
                        sp.theRoles =  Integer.parseInt(res.getString("id"));
                        
                        int rolenya = Integer.parseInt(res.getString("id"));
                        if(rolenya == 1){
